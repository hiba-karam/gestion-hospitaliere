...
## À propos
Application console développée en langage C pour optimiser la gestion des flux patients au sein d'un service hospitalier. Le programme implémente un système de triage médical : les patients sont organisés dynamiquement selon leur niveau d'urgence grâce à des algorithmes de structures de données. Le projet inclut également la conception complète du système (Diagrammes de cas d'utilisation, de classes et de séquence) modélisée avec StarUML.
